...
import { Parser, Lexer, ChangeDetection, DynamicChangeDetection, JitChangeDetection, PreGeneratedChangeDetection, PipeRegistry, defaultPipeRegistry } from 'angular2/change_detection';
...
function _injectorBindings(appComponentType) {
    ...
    return [
        ...
        bind(appComponentType)
            .toFactory((p) => p.then(ref => ref.instance), [appComponentRefToken]),
        bind(LifeCycle)
...
export function bootstrap(appComponentType, componentInjectableBindings = null, errorReporter = null) {
    ...
    zone.run(() => {
        ...
        var compRefToken = PromiseWrapper.wrap(() => appInjector.get(appComponentRefToken));
