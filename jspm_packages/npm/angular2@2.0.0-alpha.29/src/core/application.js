...
(function(process) {
  ...
  function _injectorBindings(appComponentType) {
    ...
    return [di_1.bind(dom_renderer_1.DOCUMENT_TOKEN).toValue(dom_adapter_1.DOM.defaultDoc()), di_1.bind(application_tokens_1.appComponentTypeToken).toValue(appComponentType), di_1.bind(application_tokens_1.appComponentRefToken).toFactory(function(dynamicComponentLoader, injector, testability, registry) {
  ...
  function bootstrap(appComponentType, componentInjectableBindings, errorReporter) {
    ...
    zone.run(function() {
      ...
      var compRefToken = async_1.PromiseWrapper.wrap(function() {
        return appInjector.get(application_tokens_1.appComponentRefToken);
      });
