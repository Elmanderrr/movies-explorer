...
export declare class AppProtoView {
    ...
    constructor(render: renderApi.RenderProtoViewRef, protoChangeDetector: ProtoChangeDetector, variableBindings: Map<string, string>, variableLocations: Map<string, number>);
