 ...
 */
export declare class Directive extends Injectable {
    /**
...
export declare class Component extends Directive {
    ...
    constructor({selector, properties, events, host, exportAs, lifecycle, hostInjector, viewInjector, changeDetection, compileChildren}?: ComponentArgs);
}
 ...
 * @exportedAs angular2/annotations
 */
export declare const onDestroy: LifecycleEvent;
/**
 ...
 * @exportedAs angular2/annotations
 */
export declare const onAllChangesDone: LifecycleEvent;
