...
(function(process) {
  (function(a) {
    ...
    function y(a) {
      return "number" == typeof a && Y.isFinite(a);
    }
    function z(b) {
      var c,
          d = b[xa];
    ...
    function D(a, b) {
      return da(a) || (a = xb), new Zb(b, a);
    }
    function E(a, b) {
      return new wc(function(c) {
        var d = new pb,
            e = new qb;
    ...
    function I(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ja(e) && (e = pc(e)), (Aa(e) || za(e)) && (e = Yb(e)), e;
      }).concatAll();
    }
    function J(a, b, c) {
    ...
    function N(a, b, c) {
      ...
      if (a.attachEvent) {
        ...
        return a.attachEvent("on" + b, d), lb(function() {
          a.detachEvent("on" + b, d);
        });
      }
      return a["on" + b] = c, lb(function() {
        a["on" + b] = null;
      });
    }
    function O(a, b, c) {
    ...
    function R(a, b) {
      return new wc(function(c) {
        return b.scheduleWithRelative(tb(a), function() {
          c.onNext(0), c.onCompleted();
        });
      });
    }
    function S(a, b, c) {
      return a === b ? new wc(function(a) {
        return c.schedulePeriodicWithState(0, b, function(b) {
          return a.onNext(b), b + 1;
        });
      }) : Tb(function() {
        return Q(c.now() + a, b, c);
      });
    }
    function T(a, b, c) {
      return new wc(function(d) {
 ...
 while (null !== g);
    ...
    var X = {
      ...
      undefined: !1
        ...
        Z = X[typeof exports] && exports && !exports.nodeType && exports,
        $ = X[typeof module] && module && !module.nodeType && module,
        _ = $ && $.exports === Z && Z,
        aa = X[typeof global] && global;
    !aa || aa.global !== aa && aa.window !== aa || (Y = aa);
    var ba = {
      internals: {},
      config: {Promise: Y.Promise},
      helpers: {}
    },
        ...
        ka = (ba.helpers.asArray = function() {
          ...
          return !a;
        }, ba.helpers.isFunction = function() {
          var a = function(a) {
    ...
    var Ya = ba.internals.isObject = function(a) {
      var b = typeof a;
    ...
    {
      var $a,
          _a = ba.internals.isEqual = function(a, b) {
            return m(a, b, [], []);
          },
          ab = {e: {}},
      ...
      ba.internals.addRef = function(a, b) {
        return new wc(function(c) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
      var b = this,
          c = bb.call(arguments, 1),
          d = function() {
            function e() {}
            if (this instanceof d) {
              e.prototype = b.prototype;
              var f = new e,
                  g = b.apply(f, c.concat(bb.call(arguments)));
              return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(bb.call(arguments)));
          };
      return d;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = fb && {}.toString.call(this) == Oa ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if ({}.toString.call(a) != Ka)
        throw new TypeError(a + " is not a function");
      for (var f = 0; d > f; f++)
    ...
    var lb = kb.create = function(a) {
      return new kb(a);
        ...
        }(), ba.internals.ScheduledItem = function(a, b, c, d, e) {
    ...
    }(sb.prototype), function() {
      sb.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, sb.prototype.schedulePeriodicWithState = function(a, b, c) {
        if ("undefined" == typeof Y.setInterval)
          throw new ta;
        b = tb(b);
        var d = a,
            e = Y.setInterval(function() {
              d = c(d);
            }, b);
        return lb(function() {
          Y.clearInterval(e);
    ...
    var ub,
        vb,
        wb = sb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new sb(fa, a, wa, wa);
        }(),
        xb = sb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
          ...
          function b(b, d) {
            var e = new rb(this, b, d, this.now());
            if (c)
              c.enqueue(e);
            else {
        ...
        yb = (ba.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
          ...
          if (Y.WScript)
            ...
            if (!Y.setTimeout)
              throw new ta;
            a = Y.setTimeout, b = Y.clearTimeout;
          }
          return {
            setTimeout: a,
            clearTimeout: b
    ...
    !function() {
      ...
      function b() {
        ...
        var a = !1,
            b = Y.onmessage;
        return Y.onmessage = function() {
          a = !0;
        }, Y.postMessage("", "*"), Y.onmessage = b, a;
      }
      function c(b) {
      ...
      var g = RegExp("^" + String(Pa).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          h = "function" == typeof(h = aa && _ && aa.setImmediate) && !g.test(h) && h;
      if (ka(h))
        ub = function(b) {
          var c = d++;
        ...
        Y.addEventListener ? Y.addEventListener("message", c, !1) : Y.attachEvent("onmessage", c, !1), ub = function(a) {
          var b = d++;
          return e[b] = a, Y.postMessage(i + currentId, "*"), b;
        };
      } else if (Y.MessageChannel) {
        var j = new Y.MessageChannel;
        ...
        ub = "document" in Y && "onreadystatechange" in Y.document.createElement("script") ? function(b) {
          var c = Y.document.createElement("script"),
              f = d++;
          return e[f] = b, c.onreadystatechange = function() {
            a(f), c.onreadystatechange = null, c.parentNode.removeChild(c), c = null;
          }, Y.document.documentElement.appendChild(c), f;
        } : function(b) {
          var c = d++;
          return e[c] = b, zb(function() {
            a(c);
          }, 0), c;
        };
    }();
    var Bb = sb.timeout = sb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new pb,
            e = ub(function() {
      ...
      return new sb(fa, a, b, c);
    }(),
        Cb = ba.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return da(a) || (a = wb), new wc(function(c) {
        ...
        Db = Cb.createOnNext = function() {
          ...
          return function(d) {
            return new Cb("N", d, null, a, b, c);
          };
        }(),
        Eb = Cb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new Cb("E", null, d, a, b, c);
          };
        }(),
        Fb = Cb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new Cb("C", null, null, a, b, c);
          };
        }(),
        Gb = ba.internals.Enumerator = function(a) {
          this._next = a;
        };
    ...
    var Hb = ba.internals.Enumerable = function(a) {
      this._iterator = a;
    };
    Hb.prototype[xa] = function() {
      return this._iterator();
    }, Hb.prototype.concat = function() {
      var a = this;
      return new wc(function(b) {
        var c,
            d = a[xa](),
            e = new qb,
            f = wb.scheduleRecursive(function(a) {
              if (!c) {
                try {
                  var f = d.next();
                } catch (g) {
    ...
    }, Hb.prototype.catchError = function() {
      var a = this;
      return new wc(function(b) {
        var c,
            d = a[xa](),
            e = new qb,
            f = wb.scheduleRecursiveWithState(null, function(a, f) {
              if (!c) {
                try {
                  var g = d.next();
                } catch (h) {
    ...
    }, Hb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new wc(function(c) {
        var d,
            e,
            ...
            j = b[xa](),
            k = new qb,
            l = wb.scheduleRecursive(function(a) {
              if (!d) {
                try {
                  var b = j.next();
                } catch (h) {
    ...
    var Ib,
        Jb = Hb.repeat = function(a, b) {
          return null == b && (b = -1), new Hb(function() {
            var c = b;
        ...
        Lb = ba.Observer = function() {},
        Mb = Lb.create = function(a, b, c) {
          return a || (a = ca), b || (b = ia), c || (c = ca), new Ob(a, b, c);
        },
        Nb = ba.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Ob = ba.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Pb = ba.Observable = function() {
          function a(a) {
            if (ba.config.longStackSupport && la) {
              try {
                throw new Error;
              } catch (b) {
          ...
          return Ib = a.prototype, Ib.subscribe = Ib.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Mb(a, b, c));
          }, Ib.subscribeOnNext = function(a, b) {
            return this._subscribe(Mb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ib.subscribeOnError = function(a, b) {
            return this._subscribe(Mb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ib.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Mb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, a;
        }(),
        Qb = ba.ObservableBase = function(a) {
          function b(a) {
            return a && ka(a.dispose) ? a : ka(a) ? lb(a) : mb;
          }
          function c(a, c) {
            var d = c[0],
                e = c[1],
          ...
          function d(a) {
            var b = new xc(a),
                d = [b, this];
            return xb.scheduleRequired() ? xb.scheduleWithState(d, c) : c(null, d), b;
          }
          function e() {
            a.call(this, d);
          }
        ...
        Rb = ba.internals.ScheduledObserver = function(a) {
          function b(b, c) {
    ...
    var Tb = Pb.defer = function(a) {
      return new wc(function(b) {
        ...
        return ja(c) && (c = pc(c)), c.subscribe(b);
      });
    },
        Ub = Pb.empty = function(a) {
          return da(a) || (a = wb), new wc(function(b) {
    ...
    var Yb = Pb.from = function(a, b, c, d) {
      if (null == a)
    ...
    {
      var $b = Pb.fromArray = function(a, b) {
        return da(b) || (b = xb), new Zb(a, b);
      };
      Pb.never = function() {
    ...
    Pb.of = function() {
      ...
      return b || (b = ba.Scheduler.currentThread), new wc(function(c) {
        var d = Object.keys(a),
            e = d.length;
    ...
    Pb.range = function(a, b, c) {
      return da(c) || (c = xb), new _b(a, b, c);
    }, Pb.repeat = function(a, b, c) {
      return da(c) || (c = xb), bc(a, c).repeat(null == b ? -1 : b);
    };
    var bc = Pb["return"] = Pb.just = Pb.returnValue = function(a, b) {
      return da(b) || (b = wb), new wc(function(c) {
        return b.scheduleWithState(a, function(a, b) {
          c.onNext(b), c.onCompleted();
        });
      });
    },
        cc = Pb["throw"] = Pb.throwError = function(a, b) {
          return da(b) || (b = wb), new wc(function(c) {
    ...
    Pb.throwException = function() {
      return Pb.throwError.apply(null, arguments);
    }, Ib["catch"] = Ib.catchError = Ib.catchException = function(a) {
      return "function" == typeof a ? E(this, a) : dc([this, a]);
    };
    var dc = Pb.catchError = Pb["catch"] = Pb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
        for (var b = 0,
          ...
          a.push(arguments[b]);
      return Kb(a).catchError();
    };
    Ib.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), ec.apply(this, b);
    };
    var ec = Pb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new wc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new pb;
            ja(f) && (f = pc(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Ib.concat = function() {
      for (var a = [],
          ...
          c = arguments.length; c > b; b++)
        a.push(arguments[b]);
      return a.unshift(this), fc.apply(null, a);
    };
    var fc = Pb.concat = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    Ib.concatAll = Ib.concatObservable = function() {
      return this.merge(1);
    };
    var gc = function(a) {
      function b(b, c) {
      ...
      return cb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new ib;
        return b.add(this.source.subscribe(new hc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Qb),
        hc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new pb;
            this.g.add(c), ja(a) && (a = pc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Ib.merge = function(a) {
      return "number" != typeof a ? ic(this, a) : new gc(this, a);
    };
    var ic = Pb.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), D(a, c).mergeAll();
        ...
        jc = function(a) {
          ...
          return cb(b, a), b.prototype.subscribeCore = function(a) {
            var b = new ib,
                c = new pb;
            return b.add(c), c.setDisposable(this.source.subscribe(new kc(a, b))), b;
          }, b;
        }(Qb),
        kc = function() {
          function a(a, b) {
          ...
          return a.prototype.onNext = function(a) {
            if (!this.isStopped) {
              var c = new pb;
              this.g.add(c), ja(a) && (a = pc(a)), c.setDisposable(a.subscribe(new b(this, this.g, c)));
            }
          }, a.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, a.prototype.onCompleted = function() {
    ...
    Ib.mergeAll = Ib.mergeObservable = function() {
      return new jc(this);
    };
    var lc = ba.CompositeError = function(a) {
    ...
    lc.prototype = Error.prototype, Pb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      var d = D(null, a);
      return new wc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new lc(g));
        }
        var c = new ib,
            e = new pb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new pb;
          c.add(e), ja(d) && (d = pc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    }, Ib["switch"] = Ib.switchLatest = function() {
      var a = this;
      return new wc(function(b) {
        var c = !1,
            d = new qb,
            ...
            g = a.subscribe(function(a) {
              var g = new pb,
                  h = ++f;
              c = !0, d.setDisposable(g), ja(a) && (a = pc(a)), g.setDisposable(a.subscribe(function(a) {
                f === h && b.onNext(a);
              }, function(a) {
                f === h && b.onError(a);
              }, function() {
    ...
    }, Ib.takeUntil = function(a) {
      var b = this;
      return new wc(function(c) {
        return ja(a) && (a = pc(a)), new ib(b.subscribe(c), a.subscribe(function() {
          c.onCompleted();
        }, function(a) {
          c.onError(a);
        }, ca));
      }, b);
    }, Ib.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new wc(function(a) {
        for (var c = function() {
          ...
          !function(c) {
            var d = b[c],
                e = new pb;
            ja(d) && (d = pc(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new wc(function(a) {
        function c(b) {
          var c,
              f;
        ...
        for (var g = b.length,
          ...
          !function(d) {
            var e = b[d],
                g = new pb;
            ja(e) && (e = pc(e)), g.setDisposable(e.subscribe(function(a) {
              h[d].push(a), c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    }, Ib.asObservable = function() {
      var a = this;
      return new wc(function(b) {
        return a.subscribe(b);
      }, this);
    }, Ib.dematerialize = function() {
      var a = this;
      return new wc(function(b) {
    ...
    }, Ib.distinctUntilChanged = function(a, b) {
      var c = this;
      return b || (b = ga), new wc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
    ...
    }, Ib["do"] = Ib.tap = Ib.doAction = function(a, b, c) {
      var d = this;
      return new wc(function(e) {
        var f = !a || ka(a) ? Mb(a || ca, b || ca, c || ca) : a;
    ...
    }, Ib.doOnNext = Ib.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Ib.doOnError = Ib.tapOnError = function(a, b) {
      return this.tap(ca, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Ib.doOnCompleted = Ib.tapOnCompleted = function(a, b) {
      return this.tap(ca, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Ib["finally"] = Ib.ensure = function(a) {
      var b = this;
      return new wc(function(c) {
        var d;
        try {
    ...
    }, Ib.finallyAction = function(a) {
      return this.ensure(a);
    }, Ib.ignoreElements = function() {
      var a = this;
      return new wc(function(b) {
    ...
    }, Ib.materialize = function() {
      var a = this;
      return new wc(function(b) {
        return a.subscribe(function(a) {
          b.onNext(Db(a));
        }, function(a) {
          b.onNext(Eb(a)), b.onCompleted();
        }, function() {
          b.onNext(Fb()), b.onCompleted();
        });
      }, a);
    }, Ib.repeat = function(a) {
      return Jb(this, a).concat();
    }, Ib.retry = function(a) {
      return Jb(this, a).catchError();
    }, Ib.retryWhen = function(a) {
      return Jb(this).catchErrorWhen(a);
    }, Ib.scan = function() {
      var a,
          b,
          c = !1,
          d = this;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new wc(function(e) {
        var f,
            g,
            h;
    ...
    }, Ib.startWith = function() {
      var a,
          b = 0;
      arguments.length && da(arguments[0]) ? (a = arguments[0], b = 1) : a = wb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Kb([$b(c, a), this]).concat();
    }, Ib.takeLast = function(a) {
      if (0 > a)
        throw new sa;
      var b = this;
      return new wc(function(c) {
    ...
    }, Ib.selectConcat = Ib.concatMap = function(a, b, c) {
      return ka(a) && ka(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ja(e) && (e = pc(e)), (Aa(e) || za(e)) && (e = Yb(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : ka(a) ? I(this, a, c) : I(this, function() {
        return a;
      });
    };
    var mc = function(a) {
    ...
    J.prototype.onNext = function(a) {
      ...
      return this.isStopped ? !1 : (this.isStopped = !0, this.observer.onError(a), !0);
    }, Ib.map = Ib.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof mc ? this.internalMap(c, b) : new mc(this, c, b);
    }, Ib.pluck = function() {
      var b = arguments,
          c = arguments.length;
      if (0 === c)
    ...
    }, Ib.selectMany = Ib.flatMap = function(a, b, c) {
      return ka(a) && ka(b) ? this.flatMap(function(c, d) {
        var e = a(c, d);
        return ja(e) && (e = pc(e)), (Aa(e) || za(e)) && (e = Yb(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }, c) : ka(a) ? K(this, a, c) : K(this, function() {
        return a;
      });
    }, Ib.selectSwitch = Ib.flatMapLatest = Ib.switchMap = function(a, b) {
    ...
    }, Pb.fromNodeCallback = function(a, b, c) {
      return function() {
        for (var d = arguments.length,
            e = new Array(d),
            f = 0; d > f; f++)
    ...
    }, ba.config.useNativeEvents = !1, Pb.fromEvent = function(a, b, c) {
      return a.addListener ? oc(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : ba.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new wc(function(d) {
    ...
    var oc = Pb.fromEventPattern = function(a, b, c) {
      return new wc(function(d) {
        function e(a) {
          var b = a;
          if (c)
    ...
    Ib.toPromise = function(a) {
      ...
      return pc(b);
    }, Ib.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new wc(function(d) {
        var e = c.multicast(a());
        return new ib(b(e).subscribe(d), e.connect());
      }, c) : new qc(c, a);
    }, Ib.publish = function(a) {
      return a && ka(a) ? this.multicast(function() {
        return new zc;
      }, a) : this.multicast(new zc);
    }, Ib.share = function() {
      return this.publish().refCount();
    }, Ib.publishLast = function(a) {
      return a && ka(a) ? this.multicast(function() {
        return new Ac;
      }, a) : this.multicast(new Ac);
    }, Ib.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Cc(b);
      }, a) : this.multicast(new Cc(a));
    }, Ib.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, Ib.replay = function(a, b, c, d) {
      return a && ka(a) ? this.multicast(function() {
        return new Dc(b, c, d);
      }, a) : this.multicast(new Dc(b, c, d));
    }, Ib.shareReplay = function(a, b, c) {
      return this.replay(null, a, b, c).refCount();
    };
    {
      var qc = ba.ConnectableObservable = function(a) {
        function b(b, c) {
          var d,
              e = !1,
              f = b.asObservable();
        ...
        return cb(b, a), b.prototype.refCount = function() {
          ...
          rc = Pb.interval = function(a, b) {
            return S(a, a, da(b) ? b : Bb);
          };
      Pb.timer = function(b, c, d) {
        var e;
        return da(d) || (d = Bb), c !== a && "number" == typeof c ? e = c : da(c) && (d = c), b instanceof Date && e === a ? P(b.getTime(), d) : b instanceof Date && e !== a ? (e = c, Q(b.getTime(), e, d)) : e === a ? R(b, d) : S(b, e, d);
      };
    }
    Ib.delay = function(a, b) {
      return da(b) || (b = Bb), a instanceof Date ? U(this, a.getTime(), b) : T(this, a, b);
    }, Ib.debounce = Ib.throttleWithTimeout = function(a, b) {
      da(b) || (b = Bb);
      var c = this;
      return new wc(function(d) {
        var e,
    ...
    }, Ib.throttle = function(a, b) {
      return this.debounce(a, b);
    }, Ib.timestamp = function(a) {
      return da(a) || (a = Bb), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, Ib.sample = Ib.throttleLatest = function(a, b) {
      return da(b) || (b = Bb), "number" == typeof a ? V(this, rc(a, b)) : V(this, a);
    }, Ib.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = cc(new Error(b || "Timeout"))), da(c) || (c = Bb);
      var d = this,
          e = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new wc(function(f) {
        function g() {
          var d = h;
          l.setDisposable(c[e](a, function() {
            h === d && (ja(b) && (b = pc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new pb,
    ...
    var sc = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new zc, this.pauser = d && d.subscribe ? this.controller.merge(d) : this.controller, a.call(this, b, c);
      }
    ...
    var tc = function(b) {
      function c(b) {
        var c,
            d = [],
            e = W(this.source, this.pauser.distinctUntilChanged().startWith(!1), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new zc, this.pauser = d && d.subscribe ? this.controller.merge(d) : this.controller, b.call(this, c, a);
      }
    ...
    Ib.pausableBuffered = function(a) {
    ...
    var uc = function(a) {
      ...
      function c(c, d) {
        a.call(this, b, c), this.subject = new vc(d), this.source = c.multicast(this.subject).refCount();
      }
      return cb(c, a), c.prototype.request = function(a) {
        ...
        vc = function(a) {
          ...
          function c(c) {
            null == c && (c = !0), a.call(this, b), this.subject = new zc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = mb, this.error = null, this.hasFailed = !1, this.hasCompleted = !1;
          }
          return cb(c, a), db(c.prototype, Lb, {
    ...
    Ib.controlled = function(a) {
      return null == a && (a = !0), new uc(this, a);
    }, Ib.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var wc = ba.AnonymousObservable = function(a) {
      function b(a) {
        return a && ka(a.dispose) ? a : ka(a) ? lb(a) : mb;
      }
      function c(a, c) {
      ...
      function d(b, d) {
        function e(a) {
          var d = new xc(a),
              e = [d, b];
          return xb.scheduleRequired() ? xb.scheduleWithState(e, c) : c(null, e), d;
        }
    ...
    var zc = ba.Subject = function(a) {
      function c(a) {
        return ob(this), this.isStopped ? this.hasError ? (a.onError(this.error), mb) : (a.onCompleted(), mb) : (this.observers.push(a), new yc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return cb(d, a), db(d.prototype, Lb.prototype, {
        ...
        Ac = ba.AsyncSubject = function(a) {
          function c(a) {
            return ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), mb) : (this.observers.push(a), new yc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return cb(d, a), db(d.prototype, Lb, {
            hasObservers: function() {
        ...
        Bc = ba.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return cb(c, a), db(c.prototype, Lb.prototype, {
            onCompleted: function() {
        ...
        Cc = ba.BehaviorSubject = function(a) {
          function c(a) {
            return ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), mb) : (this.observers.push(a), a.onNext(this.value), new yc(this, a));
          }
          function d(b) {
        ...
        Dc = ba.ReplaySubject = function(a) {
          function c(a, b) {
            return lb(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || xb, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return cb(e, a), db(e.prototype, Lb.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(zc), "function" == typeof define && "object" == typeof define.amd && define.amd ? (Y.Rx = ba, define(function() {
      return ba;
    })) : Z && $ ? _ ? ($.exports = ba).Rx = ba : Z.Rx = ba : Y.Rx = ba;
    var Ec = g();
  }).call(this);
})(require("process"));
