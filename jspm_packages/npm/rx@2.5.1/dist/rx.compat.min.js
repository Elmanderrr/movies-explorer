...
(function(process) {
  (function(a) {
    ...
    function D(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && A(b) ? (b = C(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Vb ? Vb : b) : b;
    }
    function E(a, b) {
      this.observer = a, this.parent = b;
    }
    function F(a, b) {
      return Y(a) || (a = sb), new Xb(b, a);
    }
    function G(a, b) {
      return new oc(function(c) {
        var d = new jb,
            e = new kb;
    ...
    function K(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return ca(e) && (e = Pb(e)), (ta(e) || sa(e)) && (e = Wb(e)), e;
      }).concatAll();
    }
    function L(a, b, c) {
      for (var d = 0,
    ...
    var Ta,
        ...
        Ya = W.internals.addRef = function(a, b) {
          return new oc(function(c) {
            return new cb(b.getDisposable(), a.subscribe(c));
          });
        },
        Za = {e: {}};
    Function.prototype.bind || (Function.prototype.bind = function(a) {
      var b = this,
          c = Va.call(arguments, 1),
          d = function() {
            function e() {}
            if (this instanceof d) {
              e.prototype = b.prototype;
              var f = new e,
                  g = b.apply(f, c.concat(Va.call(arguments)));
              return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(Va.call(arguments)));
          };
      return d;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = _a && {}.toString.call(this) == Ha ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if ({}.toString.call(a) != Da)
        throw new TypeError(a + " is not a function");
      for (var f = 0; d > f; f++)
    ...
    var ab = W.internals.PriorityQueue = function(a) {
      this.items = new Array(a), this.length = 0;
    },
        bb = ab.prototype;
    bb.isHigherPriority = function(a, b) {
      return this.items[a].compareTo(this.items[b]) < 0;
    }, bb.percolate = function(a) {
    ...
    var cb = W.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var eb = W.Disposable = function(a) {
      this.isDisposed = !1, this.action = a || X;
    };
    eb.prototype.dispose = function() {
      this.isDisposed || (this.action(), this.isDisposed = !0);
    };
    var fb = eb.create = function(a) {
      return new eb(a);
    },
        gb = eb.empty = {dispose: X},
        hb = eb.isDisposable = function(a) {
          return a && da(a.dispose);
        },
        ib = eb.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new ka;
        },
        jb = W.SingleAssignmentDisposable = function() {
          function a() {
        ...
        kb = W.SerialDisposable = jb,
        lb = W.RefCountDisposable = function() {
          function a(a) {
          ...
          return a.prototype.dispose = function() {
            ...
            return this.isDisposed ? gb : new a(this);
          }, b;
        }();
    t.prototype.dispose = function() {
      this.scheduler.scheduleWithState(this, u);
    };
    var mb = W.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || aa, this.disposable = new jb;
    };
    mb.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, mb.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, mb.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, mb.prototype.invokeCore = function() {
      return this.action(this.scheduler, this.state);
    };
    var nb = W.Scheduler = function() {
      function a(a, b, c, d) {
          ...
          e(b, function(b) {
            var d = !1,
                ...
                g = a.scheduleWithState(b, function(a, b) {
                  return d ? f.remove(g) : e = !0, c(b), gb;
                });
            e || (f.add(g), d = !0);
          });
        }
          ...
          f(b, function(b, e) {
            var f = !1,
                ...
                i = a[c](b, e, function(a, b) {
                  return f ? g.remove(i) : h = !0, d(b), gb;
                });
            h || (g.add(i), f = !0);
          });
        }
    ...
    }(nb.prototype), function() {
      nb.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, nb.prototype.schedulePeriodicWithState = function(a, b, c) {
    ...
    var pb,
        qb,
        rb = (W.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        }(), nb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new nb($, a, pa, pa);
        }()),
        sb = nb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
          ...
          function b(b, d) {
            var e = new mb(this, b, d, this.now());
            if (c)
              c.enqueue(e);
            else {
              c = new ab(4), c.enqueue(e);
              var f = p(a)();
              if (c = null, f === Za)
                return q(f.e);
            }
    ...
    !function() {
      ...
      if (da(h))
        ...
        R.addEventListener ? R.addEventListener("message", c, !1) : R.attachEvent("onmessage", c, !1), pb = function(a) {
          var b = d++;
        ...
        pb = "document" in R && "onreadystatechange" in R.document.createElement("script") ? function(b) {
    ...
    var wb = (nb.timeout = nb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new jb,
            e = pb(function() {
      ...
      return Wa(e, a), e.prototype._clone = function(a) {
        ...
        xb = W.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return Y(a) || (a = rb), new oc(function(c) {
        ...
        Bb = W.internals.Enumerator = function(a) {
          this._next = a;
        };
    ...
    var Cb = W.internals.Enumerable = function(a) {
      this._iterator = a;
    };
    Cb.prototype[qa] = function() {
      ...
      return new oc(function(c) {
        var d,
            ...
            l = rb.scheduleRecursive(function(a) {
              if (!d) {
                ...
                var l = new jb,
                    m = new jb;
                k.setDisposable(new cb(m, l)), l.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new cb(i, k, l, fb(function() {
          d = !0;
        }));
      });
    };
    ...
    var Gb = Fb.create = function(a, b, c) {
      return a || (a = X), b || (b = ba), c || (c = X), new Jb(a, b, c);
    };
    ...
    var Hb,
        Ib = W.internals.AbstractObserver = function(a) {
          function b() {
        ...
        Jb = W.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Lb = W.internals.ScheduledObserver = function(a) {
          function b(b, c) {
            a.call(this), this.scheduler = b, this.observer = c, this.isAcquired = !1, this.hasFaulted = !1, this.queue = [], this.disposable = new kb;
          }
          return Wa(b, a), b.prototype.next = function(a) {
            var b = this;
        ...
        Ob = W.ObservableBase = function(a) {
          function b(a) {
            return a && da(a.dispose) ? a : da(a) ? fb(a) : gb;
          }
          function c(a, c) {
            var d = c[0],
                e = c[1],
    ...
    var Rb = Nb.defer = function(a) {
      return new oc(function(b) {
        ...
        try {
          ...
          return bc(d).subscribe(b);
        }
        return ca(c) && (c = Pb(c)), c.subscribe(b);
      });
    },
        Sb = Nb.empty = function(a) {
          return Y(a) || (a = rb), new oc(function(b) {
    ...
    var Wb = Nb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Yb = Nb.fromArray = function(a, b) {
      return Y(b) || (b = sb), new Xb(a, b);
    };
    Nb.generate = function(a, b, c, d, e) {
      return Y(e) || (e = sb), new oc(function(f) {
        var g = !0;
    ...
    var Zb = Nb.never = function() {
      return new oc(function() {
        return gb;
      });
    };
    Nb.of = function() {
      ...
      return b || (b = W.Scheduler.currentThread), new oc(function(c) {
        var d = Object.keys(a),
            e = d.length;
    ...
    Nb.range = function(a, b, c) {
      return Y(c) || (c = sb), new $b(a, b, c);
    }, Nb.repeat = function(a, b, c) {
      return Y(c) || (c = sb), ac(a, c).repeat(null == b ? -1 : b);
    };
    var ac = Nb["return"] = Nb.just = Nb.returnValue = function(a, b) {
      return Y(b) || (b = rb), new oc(function(c) {
        return b.scheduleWithState(a, function(a, b) {
          c.onNext(b), c.onCompleted();
        });
      });
    },
        bc = Nb["throw"] = Nb.throwError = function(a, b) {
          return Y(b) || (b = rb), new oc(function(c) {
    ...
    Nb.throwException = function() {
      return Nb.throwError.apply(null, arguments);
      ...
      return new oc(function(c) {
        ...
        try {
          ...
          return new cb(bc(g).subscribe(c), f);
        }
        return new cb(e.subscribe(c), f);
      });
    }, Hb.amb = function(a) {
      var b = this;
      return new oc(function(c) {
        ...
        var f,
            ...
            i = new jb,
            j = new jb;
        return ca(a) && (a = Pb(a)), i.setDisposable(b.subscribe(function(a) {
          d(), f === g && c.onNext(a);
        }, function(a) {
          d(), f === g && c.onError(a);
        }, function() {
      ...
      return "function" == typeof a ? G(this, a) : cc([this, a]);
    };
    var cc = Nb.catchError = Nb["catch"] = Nb.catchException = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
    ...
    Hb.combineLatest = function() {
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), dc.apply(this, b);
    };
    var dc = Nb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = b.pop();
      return Array.isArray(b[0]) && (b = b[0]), new oc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new jb;
            ca(f) && (f = Pb(f)), g.setDisposable(f.subscribe(function(a) {
              k[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Hb.concat = function() {
      for (var a = [],
          ...
          c = arguments.length; c > b; b++)
        a.push(arguments[b]);
      return a.unshift(this), ec.apply(null, a);
    };
    var ec = Nb.concat = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    var fc = function(a) {
      ...
      return Wa(b, a), b.prototype.subscribeCore = function(a) {
        var b = new cb;
        return b.add(this.source.subscribe(new gc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Ob),
        gc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new jb;
            this.g.add(c), ca(a) && (a = Pb(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Hb.merge = function(a) {
      return "number" != typeof a ? hc(this, a) : new fc(this, a);
    };
    var hc = Nb.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), F(a, c).mergeAll();
        ...
        ic = function(a) {
          ...
          return Wa(b, a), b.prototype.subscribeCore = function(a) {
            var b = new cb,
                c = new jb;
            return b.add(c), c.setDisposable(this.source.subscribe(new jc(a, b))), b;
          }, b;
        }(Ob),
        jc = function() {
          function a(a, b) {
          ...
          return a.prototype.onNext = function(a) {
            if (!this.isStopped) {
              var c = new jb;
              this.g.add(c), ca(a) && (a = Pb(a)), c.setDisposable(a.subscribe(new b(this, this.g, c)));
            }
          }, a.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, a.prototype.onCompleted = function() {
    ...
    var kc = W.CompositeError = function(a) {
    ...
    kc.prototype = Error.prototype, Nb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new oc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : a.onError(1 === g.length ? g[0] : new kc(g));
        }
        var c = new cb,
            e = new jb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new jb;
          c.add(e), ca(d) && (d = Pb(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var lc = Nb.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new oc(function(b) {
        var c = 0,
            ...
            e = rb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], ca(f) && (f = Pb(f)), g = new jb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new cb(d, e);
      });
    };
    Hb.skipUntil = function(a) {
      ...
      return new oc(function(c) {
        var d = !1,
            e = new cb(b.subscribe(function(a) {
              d && c.onNext(a);
            }, function(a) {
              c.onError(a);
            }, function() {
      ...
      return new oc(function(b) {
        var c = !1,
            ...
            g = a.subscribe(function(a) {
              var g = new jb,
                  h = ++f;
              c = !0, d.setDisposable(g), ca(a) && (a = Pb(a)), g.setDisposable(a.subscribe(function(a) {
                f === h && b.onNext(a);
              }, function(a) {
                f === h && b.onError(a);
              }, function() {
      ...
      var b = this;
      return new oc(function(c) {
        return ca(a) && (a = Pb(a)), new cb(b.subscribe(c), a.subscribe(function() {
          c.onCompleted();
        }, function(a) {
          c.onError(a);
        }, X));
      ...
      return Array.isArray(b[0]) && (b = b[0]), new oc(function(a) {
        for (var c = function() {
          ...
          !function(c) {
            var d = b[c],
                e = new jb;
            ca(d) && (d = Pb(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      var d = this,
          e = b.pop();
      return b.unshift(d), new oc(function(a) {
        function c(b) {
          var c,
              f;
        ...
        for (var g = b.length,
          ...
          !function(d) {
            var e = b[d],
                g = new jb;
            ca(e) && (e = Pb(e)), g.setDisposable(e.subscribe(function(a) {
              h[d].push(a), c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
      ...
      return new oc(function(b) {
        ...
        for (var e = a.length,
            ...
            i = 0; e > i; i++)
          !function(e) {
            h[e] = new jb, h[e].setDisposable(a[e].subscribe(function(a) {
              f[e].push(a), c(e);
            }, function(a) {
              b.onError(a);
            }, function() {
      ...
      var c = this;
      return b || (b = _), new oc(function(d) {
        var e,
            f = !1;
        return c.subscribe(function(c) {
          var g = c;
      ...
      var d = this;
      return new oc(function(e) {
        var f = !a || da(a) ? Gb(a || X, b || X, c || X) : a;
      ...
      var a,
          ...
          c = !1,
          d = this;
      return 2 === arguments.length ? (c = !0, a = arguments[0], b = arguments[1]) : b = arguments[0], new oc(function(e) {
        var f,
            g,
            h;
      ...
      var a,
          b = 0;
      arguments.length && Y(arguments[0]) ? (a = arguments[0], b = 1) : a = rb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Eb([Yb(c, a), this]).concat();
      ...
      return da(a) && da(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return ca(e) && (e = Pb(e)), (ta(e) || sa(e)) && (e = Wb(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      ...
      return new oc(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          ca(c) && (c = Pb(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          ca(b) && (b = Pb(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, Hb.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new oc(function(a) {
        var d = !1;
    ...
    N.prototype.onNext = function(a) {
      ...
      return new oc(function(f) {
        ...
        return e.subscribe(function(b) {
          ...
          ca(c) && (c = Pb(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          ca(a) && (a = Pb(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    ...
    var oc = W.AnonymousObservable = function(a) {
      function b(a) {
        return a && da(a.dispose) ? a : da(a) ? fb(a) : gb;
      }
      function c(a, c) {
      ...
      return Wa(d, a), d;
        ...
        pc = function(a) {
          function b(b) {
            a.call(this), this.observer = b, this.m = new jb;
          }
          Wa(b, a);
          var c = b.prototype;
    ...
    var rc = W.Subject = function(a) {
      function c(a) {
        return ib(this), this.isStopped ? this.hasError ? (a.onError(this.error), gb) : (a.onCompleted(), gb) : (this.observers.push(a), new qc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return Wa(d, a), Xa(d.prototype, Fb.prototype, {
        hasObservers: function() {
          return this.observers.length > 0;
        },
        onCompleted: function() {
          if (ib(this), !this.isStopped) {
            this.isStopped = !0;
            for (var a = 0,
                c = b(this.observers),
                d = c.length; d > a; a++)
        ...
        sc = (W.AsyncSubject = function(a) {
          function c(a) {
            return ib(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), gb) : (this.observers.push(a), new qc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return Wa(d, a), Xa(d.prototype, Fb, {
            hasObservers: function() {
              return ib(this), this.observers.length > 0;
            },
            onCompleted: function() {
              var a,
                  c;
            ...
            onNext: function(a) {
              ib(this), this.isStopped || (this.value = a, this.hasValue = !0);
            },
            dispose: function() {
              this.isDisposed = !0, this.observers = null, this.exception = null, this.value = null;
            }
          }), d;
        }(Nb), W.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Wa(c, a), Xa(c.prototype, Fb.prototype, {
            onCompleted: function() {
