...
(function(process) {
 ...
 while (null !== g);
    ...
    var rb,
        sb,
        tb = pb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new pb(ea, a, va, va);
        }(),
        ub = pb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.dequeue();
        ...
        vb = (aa.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
    ...
    !function() {
      ...
      var g = RegExp("^" + String(Oa).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          h = "function" == typeof(h = _ && $ && _.setImmediate) && !g.test(h) && h;
      if (ja(h))
        rb = function(b) {
          var c = d++;
        ...
        X.addEventListener ? X.addEventListener("message", c, !1) : X.attachEvent("onmessage", c, !1), rb = function(a) {
          var b = d++;
          return e[b] = a, X.postMessage(i + currentId, "*"), b;
        };
        ...
        rb = "document" in X && "onreadystatechange" in X.document.createElement("script") ? function(b) {
          var c = X.document.createElement("script"),
              f = d++;
          return e[f] = b, c.onreadystatechange = function() {
            a(f), c.onreadystatechange = null, c.parentNode.removeChild(c), c = null;
          }, X.document.documentElement.appendChild(c), f;
        } : function(b) {
          var c = d++;
      ...
      return new pb(ea, a, b, c);
        ...
        zb = aa.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return ca(a) || (a = tb), new tc(function(c) {
    ...
    var Qb = Mb.defer = function(a) {
      return new tc(function(b) {
        ...
        Rb = Mb.empty = function(a) {
          return ca(a) || (a = tb), new tc(function(b) {
    ...
    Mb.range = function(a, b, c) {
      return ca(c) || (c = ub), new Yb(a, b, c);
    }, Mb.repeat = function(a, b, c) {
      return ca(c) || (c = ub), $b(a, c).repeat(null == b ? -1 : b);
    };
    var $b = Mb["return"] = Mb.just = Mb.returnValue = function(a, b) {
      return ca(b) || (b = tb), new tc(function(c) {
        return b.scheduleWithState(a, function(a, b) {
          c.onNext(b), c.onCompleted();
        });
      });
    },
        _b = Mb["throw"] = Mb.throwError = function(a, b) {
          return ca(b) || (b = tb), new tc(function(c) {
    ...
    Fb.mergeAll = Fb.mergeObservable = function() {
      ...
      return new tc(function(e) {
        var f = !a || ja(a) ? Jb(a || ba, b || ba, c || ba) : a;
      ...
      var a,
          b = 0;
      arguments.length && ca(arguments[0]) ? (a = arguments[0], b = 1) : a = tb;
      for (var c = [],
          d = b,
    ...
    var wc = aa.Subject = function(a) {
      ...
      return bb(d, a), cb(d.prototype, Ib.prototype, {
        ...
        Ac = aa.ReplaySubject = function(a) {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || ub, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
    ...
    }(wc), "function" == typeof define && "object" == typeof define.amd && define.amd ? (X.Rx = aa, define(function() {
      return aa;
